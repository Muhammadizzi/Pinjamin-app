...
('70000000-0000-0000-0000-000000000008', 'Forklift Elektrik', 'Alat angkut gudang', 'RETIRED', '10000000-0000-0000-0000-000000000004', '30000000-0000-0000-0000-000000000003', 'PIN-FRK008H', 150000000, 'SN-FRK-008', NULL, 'Kapasitas 1,5 ton, baterai 48V')
ON CONFLICT (id) DO NOTHING;

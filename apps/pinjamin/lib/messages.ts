...
export const messages = {
  ...
  portalLink: ["Link portal pelapor", "Reporter portal link"],
  copyPortalLink: ["Salin link portal", "Copy portal link"],
  portalLinkCopied: ["Link portal disalin ✓", "Portal link copied ✓"],
  portalLinkHint: [
    "Link ini berisi kunci akses tiket — kirim hanya ke pelapor yang bersangkutan.",
    "This link carries the ticket's access key — send it only to the reporter.",
  ],

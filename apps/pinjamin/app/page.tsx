...
type ActivityKind = "asset" | "booking" | "audit";
...
export default function DashboardPage() {
  ...
  const activityLabel: Record<ActivityKind, string> = {
    asset: t("activityAssetCreated"),
    booking: t("activityBookingCreated"),
    audit: t("activityAuditCreated"),
  };
              ...
              <CardContent className="space-y-3 text-sm">
                {recentActivity.length === 0 ? (
                  ...
                  recentActivity.map((it) => (
                    <div
                      key={it.id}
                      className="flex gap-3 p-2 rounded-xl hover:bg-white/60 dark:hover:bg-slate-700/30 transition-colors"
                    >
                      <div
                      ...
                      <div className="min-w-0">
                        <div className="font-medium truncate">
                          {activityLabel[it.kind]}: "{it.label}"
                        </div>
                        <div className="text-xs text-muted-foreground">
